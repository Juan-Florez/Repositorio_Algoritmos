...
Complexity:
Taking n as the size of the interval for find the answer the complexity of the brute force algorithm is O(n)  O(n)+O(n)=O(2n)=O(n).
...
bisection algorithm = 0.01364874839 seconds
